...
class CalendarModule {
    constructor() {
        ...
        // Persistent storage fallback initialization
        const rawStored = StorageManager.get(this.storageKey, {
            '2026-06-15': [{ id: '1', title: 'LifeFlow AI Architecture Review', time: '', category: 'work' }],
            '2026-06-20': [{ id: '2', title: 'Frontend Code Refactoring Sprint', time: '', category: 'development' }]
        });
