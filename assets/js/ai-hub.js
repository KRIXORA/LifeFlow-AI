...
class AIHubModule {
    constructor() {
        ...
        this.messages = StorageManager.get(this.storageKey, [
            {
                sender: 'bot',
                text: 'Hi! I am your LifeFlow AI Assistant. Tell me what you would like to do — add a task, check your progress, or plan your day.',
    ...
    exportChatJSON() {
        ...
        downloadAnchor.setAttribute("download", `lifeflow_ai_chat_${Utils.fileTimestamp()}.json`);
