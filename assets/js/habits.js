        ...
        const modalHTML = `
            <div style="display: flex; flex-direction: column; gap: 14px; width: 100%; box-sizing: border-box;">
                <div class="form-group" style="display: flex; flex-direction: column; gap: 8px;">
                    ...
                    <input type="text" id="modalHabitName" value="${this.sanitizeHTML(targetHabit.name)}" placeholder="e.g., System Architecture Meditation & Review" autocomplete="off" style="padding: 12px; border-radius: var(--radius-md); border: 1px solid var(--border-glass); background: var(--bg-main); color: var(--text-primary); width: 100%; box-sizing: border-box;">
                </div>
                <div class="form-group" style="display: flex; flex-direction: column; gap: 8px;">
